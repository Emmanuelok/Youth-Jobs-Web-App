...
export const tw: Messages = {
  ...
  interview: {
    proposeTitle: "Hyɛ nhyiamu nkrataa",
    when: "Da ne berɛ",
    duration: "Berɛ tenten (simma)",
    mode: "Ɔkwan",
    modeInPerson: "Animuanim",
    modePhone: "Fon",
    modeVideo: "Video",
    locationLabel: "Beae anaa link",
    locationHelpInPerson: "Ɛhe na ɛbɛyɛ? Ka no pefee.",
    locationHelpPhone: "Sɛ ɛho hia a: nɔma a wɔbɛfrɛ.",
    locationHelpVideo: "Fa nhyiamu link no to mu.",
    notesLabel: "Nsɛm foforɔ (sɛ wopɛ, candidate behu)",
    submit: "Soma nkrataa",
    pending: "Yɛretwɛn candidate gye to mu",
    confirmed: "Wɔagye to mu",
    declined: "Wɔampene",
    cancelled: "Wɔagyae",
    completed: "Awie",
    noShow: "Wamma",
    ...
    decline: "Mpene",
    cancel: "Gyae",
    markCompleted: "Kyerɛ sɛ awie",
    markNoShow: "Kyerɛ sɛ wamma",
    safety:
      "Nhyiamu a ɛdi kan: hyia wɔ baguam awia bere mu, ka kyerɛ obi a wogye no di faako a worekɔ, na mfa sika nkɔma obi.",
    upcomingTitle: "Nhyiamu a ɛreba",
    none: "Nhyiamu biara nni hɔ.",
  },
  skills: {
    title: "Nimdeɛ badge",
    intro:
      "Yɛ nsɔhwɛ tiawa a ɛnyɛ kwa, na nya badge a wɔahwɛ so. Sɛ wobisa adwuma a, adwumawura no behu wo badge wɔ wo din ho.",
    earned: "Wowɔ saa badge yi",
    notTaken: "Wonnyɛɛ bi",
    failedRecently: "Sɔ bio kakra",
    takeButton: "Yɛ nsɔhwɛ no",
    startButton: "Fi ase seesei",
    retakeButton: "Sɔ bio",
    questionCount: "nsɛm a wɔde bisa",
    passingScore: "Nkwa ano",
    yourScore: "Wo score",
    youPassed: "Woanya badge no!",
    youDidntPass:
      "Ɛnyɛ yie ne nokware — hwɛ mmuaeɛ no, na bio bi sɔ hwɛ.",
    submitAnswers: "Soma mmuaeɛ",
    questionLabel: "Asɛmmisa",
    of: "wɔ",
    reviewExplanations: "Hwɛ mmuaeɛ no",
    backToSkills: "San kɔ badge nkyerɛwde",
    yourBadgesTitle: "Wo badge",
    noBadgesYet:
      "Wonnya badge biara — fi nsɔhwɛ no mu baako ase wɔ aseɛ ha.",
    correct: "Ɛyɛ nokware",
    incorrect: "Ɛnyɛ nokware",
    youAnswered: "Wo mmuaeɛ",
    acceptedAnswers: "Mmuaeɛ a yɛgye",
  },
  landing: {
